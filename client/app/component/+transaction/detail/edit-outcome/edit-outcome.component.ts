...
@Component({
    selector: 'edit-outcome',
    templateUrl: 'edit-outcome.component.html',
    styleUrls: ['./edit-outcome.component.scss'],
})
...
export class EditOutcomeComponent {
    ...
    constructor(private formBuilder: FormBuilder, private detailService: DetailService,
        private businessCategoryApi: BusinessCategoryApi, private router: Router,
        private accountTransactionApi: AccountTransactionApi, private utilityService: UtilityService,
        private accountTransactionModels: AccountTransactionModels,
