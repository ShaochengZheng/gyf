...
export class IncomeComponent {
    ...
    constructor(private formBuilder: FormBuilder, private detailService: DetailService, private utilityService: UtilityService,
        private businessCategoryApi: BusinessCategoryApi, private accountTransactionApi: AccountTransactionApi,
        private accountTransactionModels: AccountTransactionModels, private ref: ChangeDetectorRef, private activatedRoute: ActivatedRoute,
    ...
    validation(isSave: boolean) {
        ...
        for (let i = 0; i < this.transaction.accountTransLineItemModels.length; i++) {
            ...
            if (tempamount === '0.00' || tempamount === 0 || tempamount === null) {
