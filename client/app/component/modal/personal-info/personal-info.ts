...
@Component({
    selector: 'gpw-personal-info-modal',
...
export class PersonalInfoModalComponent {
  ...
  public clearAlert(): void {
    ...
    constructor(private userApi: UserApi, private accountApi: AccountApi, fb: FormBuilder, private pubSubService: PubSubService,
        private authorizationService: AuthorizationService, private storageService: StorageService, private ref: ChangeDetectorRef,
    ...
    // constructor(private userApi: UserApi, private authorizationService: AuthorizationService) {
    //     this.currentUser = authorizationService.Session.user;
    // }
    close() {
