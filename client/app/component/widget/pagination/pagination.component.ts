import {
  Component, ElementRef, EventEmitter, Input, OnInit, Output, Renderer, forwardRef, ViewChild
} from '@angular/core';
...
const PAGINATION_TEMPLATE = `
  <ul class="pagination" [ngClass]="classMap">
    ...
    <li  class="pagination-page page-item" 
         *ngIf="jumpLinks">
       <input type="number" #targetPage class="noborder-input page-input pagination-item text-center"></li>
    <li class="pagination-page page-item"
        *ngIf="jumpLinks">
      <a class="page-link f-right" href="javascript:void();" [innerHTML]="getText('jump')" (click)="jumpPage($event)"></a></li>
  </ul>
  `;
...
export class PaginationComponent implements ControlValueAccessor, OnInit {
  targetPage: any;
  public config: any;
  @ViewChild('targetPage') public targetInput;
  ...
  /*** if false jump button and input will be hidden  */
  @Input() public jumpLinks: boolean;
  // labels
  /** first button text */
  ...
  public ngOnInit(): void {
    ...
    this.jumpLinks = typeof this.jumpLinks !== 'undefined'
      ? this.jumpLinks
      : this.config.jumpLinks;
  ...
  public selectPage(page: number, event?: Event): void {
    console.log('selectPage', page, event);
    if (event) {
  ...
  public jumpPage(event): void {

    this.selectPage(Number(this.targetInput.nativeElement.value), event);
  }
