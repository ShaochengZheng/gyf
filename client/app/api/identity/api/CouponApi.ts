...
export class CouponApi {
     ...
     * @param companyId 
     */
    public couponGetAll (companyId: string,
      extraHttpRequestParams?: any ): Observable<Array<models.CouponModel>> {
        const path = this.basePath + '/api/v1/coupon/all';
