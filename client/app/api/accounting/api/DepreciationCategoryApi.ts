...
@Injectable()
export class DepreciationCategoryApi {
     ...
     * @param assetTypeEnum 
     */
    public depreciationCategoryGet (assetTypeEnum: string,
      extraHttpRequestParams?: any ): Observable<Array<models.DepreciationCategoryModel>> {
        const path = this.basePath + '/api/v1/depreciation_category/all';
        ...
        if (assetTypeEnum === null || assetTypeEnum === undefined) {
            throw new Error('Required parameter assetTypeEnum was null or undefined' +
              'when calling depreciationCategoryGet.');
        }
