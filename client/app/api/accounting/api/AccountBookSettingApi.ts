...
@Injectable()
export class AccountBookSettingApi {
     ...
     * 
     */
    public accountBookSettingGet (extraHttpRequestParams?: any ): Observable<models.AccountBookSettingModel> {
        const path = this.basePath + '/api/v1/accountbook_setting';
     ...
     * @param year 
     */
    public accountBookSettingGets (year: number,
      extraHttpRequestParams?: any ): Observable<Array<models.AccountBookSettingModel>> {
        const path = this.basePath + '/api/v1/accountbook_setting/${year}'
        ...
        if (year === null || year === undefined) {
            throw new Error('Required parameter year was null or undefined' +
              'when calling accountBookSettingGets.');
        }
        let requestOptions: RequestOptionsArgs = {
            method: RequestMethod.Get,
            headers: headerParams,
