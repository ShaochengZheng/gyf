...
export class ImportApi {
     ...
     * Mapping结果导出
     * 
     * @param importTaskId 银行对账单附件id
     */
    public importExport (importTaskId: string,
      extraHttpRequestParams?: any ): Observable<string> {
        const path = this.basePath + '/api/v1/import/${importTaskId}/export'
     ...
     * @param id 
     */
    public importGet (id: string,
      extraHttpRequestParams?: any ): Observable<models.ImportTaskModel> {
        const path = this.basePath + '/api/v1/import/${Id}'
     ...
     * @param taskType 
     */
    public importHistory (taskType: string,
      extraHttpRequestParams?: any ): Observable<models.ImportTaskModel> {
        const path = this.basePath + '/api/v1/import/${taskType}/history'
        ...
        if (taskType === null || taskType === undefined) {
            throw new Error('Required parameter taskType was null or undefined' +
              'when calling importHistory.');
        }
        let requestOptions: RequestOptionsArgs = {
            method: RequestMethod.Get,
            headers: headerParams,
     ...
     * @param taskType 
     */
    public importPost (taskType: string,
      extraHttpRequestParams?: any ): Observable<models.ImportTaskModel> {
        const path = this.basePath + '/api/v1/import/${taskType}'
            .replace('${' + 'taskType' + '}', String(taskType));
