...
export class TimelineApi {
     ...
     * @param pageSize 
     */
    public timelineGetByCompanyId (pageIndex?: string,
      pageSize?: string,
      extraHttpRequestParams?: any ): Observable<models.TimelineModel> {
        const path = this.basePath + '/api/v1/timeLineline/recent';
     ...
     * @param pageSize 
     */
    public timelineGetByEntityId (entityId: string,
      pageIndex?: string,
      pageSize?: string,
      extraHttpRequestParams?: any ): Observable<models.TimelineModel> {
        const path = this.basePath + '/api/v1/timeLineline/${entityId}'
